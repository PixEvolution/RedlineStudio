...
| `js/localwire.js` | The LOCAL test wire — the same net contract between windows of one browser (Studio multiplayer testing) |
...
|  `studio/example-*.js` | Reference examples: CRT Amusement Device (1947), Bertie the Brain (1950), NIMROD (1951), Draughts (1951), OXO (1952), Tennis for Two (1958), Mouse in the Maze (1959), Tic-Tac-Toe on TX-0 (1959), Spacewar! (1962), Computer Space (1971), Odyssey Table Tennis (1972), Pong (1972), Space Race (1973), Gotcha (1973), Hunt the Wumpus (Map + Teletype, 1973), Gran Trak 10 (1974), Tank (1974), Maze War (1974), Maze War Arena (1974, 4P online), Spasim (1974, 8P online 3D), Gun Fight (1975), Redline Slots |
