...
function brainCode() {
  ...
  push("      end");
  push("    end");
  // a HUMAN faces the way he walks; a DRONE always faces his foe —
  // a gunslinger backing off never turns his back on the other man
  push("    if ai1 == 0 then");
